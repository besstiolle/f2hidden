<?php
	/**
	 * Here you will provide some informations about this new Entity OldAssignment
	 *  
	 **/ 
	class OldAssignment extends OrmEntity {
		public function __construct() {
			parent::__construct('Forge2','OldAssignment', null ,'OldAssignments');
