<?php
	/**
	 * Here you will provide some informations about this new Entity Oldlicenses 
	 *  
	 **/ 
	class OldLicense extends OrmEntity {
		public function __construct() {
			parent::__construct('Forge2','OldLicense', null, 'OldLicenses');
