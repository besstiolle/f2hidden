...
$lang['param_filter_crop2size'] = '(width,height[,location]) - Perform a crop on the image specified.  This filter will copy the portion of the source image specified into the destination image.  The width and height parameters can be no larger than the size of the source image (and will be trimmed as such.  Negative values are not permitted.  Valid locations are: l,tc,tr,cl,c,cr,bl,bc,br for the 9 relative positions within the image.';
