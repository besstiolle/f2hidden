...
include(__DIR__.'/function.admin_aliases_tab.php');
echo $this->EndTab();

echo $this->StartTab('responsive',$params);
include(__DIR__.'/function.admin_responsive_tab.php');
echo $this->EndTab();

echo $this->StartTab('embedding',$params);
include(__DIR__.'/function.admin_embedding_tab.php');
echo $this->EndTab();

// echo $this->StartTab('resizing',$this->Lang('resizing'));
// include(__DIR__.'/function.admin_resizing_tab.php');
// echo $this->EndTab();
