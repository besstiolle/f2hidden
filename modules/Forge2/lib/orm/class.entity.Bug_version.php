<?php
	/**
	 * Here you will provide some informations about this new Entity Bug_version 
	 *  
	 **/ 
	class Bug_version extends OrmEntity {
		public function __construct() {
			parent::__construct('Forge2','Bug_version', null , 'Bug_versions');
