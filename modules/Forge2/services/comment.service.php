...
class commentService extends abstractService implements interfaceService {
	
	protected $serviceName = 'comment';

	protected $jsonBlock = 'comments';
	...
	public function __construct($path, $params){
		...
		$this->currentEntity = new Comment();
	}
	...
	function getAll(){
		...
		//Select by example
		$example = new OrmExample();
		if(!empty($this->params['commentable_id']) ) {
			$example->addCriteria('commentable_id', OrmTypeCriteria::$EQ, array($this->params['commentable_id']));
		}
