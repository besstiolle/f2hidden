...
$lang['settings_smartycaching'] = 'Si activé, la sortie des plugins sera mise en cache pour améliorer les performances. En outre, la plupart des parties de gabarits compilées seront mis en cache. Cela s\'applique uniquement à la sortie sur les pages de contenu marquées comme cachable, et seulement pour les utilisateurs non-administrateurs. Remarque, cette fonctionnalité peut interférer avec le comportement de certains modules ou plugins qui utilisent des formulaires non-inline. <br/><br/><strong>Remarque :</strong> Lorsque la mise en cache Smarty est activée les balises définies par l\'utilisateur balises <em>(UDT)</em> ne sont jamais mises en cache. En outre, les blocs de contenu ne sont jamais mis en cache.';
